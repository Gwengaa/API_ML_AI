...
Questions|Qutcome
-|-
提供“阿里云花伴侣智能植物识别API”识别用户拍摄或上传的植物图片|帮助用户识别图中最突出植物品种，并介绍植物详细信息（如植物识别玫瑰，则介绍玫瑰花语、玫瑰种植需知等）
使用语音合成,播放用户感兴趣的植物信息播放|解决用户在欣赏花草行进过程中情景中无法同时植物信息与其他植物的问题
使用高德地图API形成用户个人植物地图|记录用户识别植物的轨迹
使用推荐系统推荐濒危植物知识信息|呼吁用户保护濒危植物

##  Assumptions
* 用户使用该产品时，主要是在手机或者平板设备的环境下，会通过拍下想知道信息的植物.  
* 在游玩过程中（例如游玩公园)见到好奇的植物，但又处于移动过程中，立刻拍下想知道的植物的照片。
...
| ------------- |:-------------:|:-------------:|:-------------:|:-------------:|
| 看到好奇植物时拍摄植物        |   输出植物名称后，想知道植物植物信息    | 需要点击知道更多 | Must Have | 阿里花伴侣智能植物识别api |  
| 得到植物信息之后        |   输出植物图片后，想分享出去从而打卡形成植物地图    | 需要点击分享 | Must Have | 调用高德地图api |  
| 分享植物图片后        |   每分享一次将（通过推荐）获得一个濒临灭绝植物/稀有植物的碎片,点亮并获取其信息    | 需要点击收集 | Must Have | 推荐系统 |  
...
### 表现分析
#### Product Principle
* 游戏化：通过分享获得一个濒危植物知识碎片，点亮碎片可以拼凑濒危植物地图
* 平静技术互动原则：操作简易，信息提示简洁，操作路径少
...
|   如何实现推荐濒危植物知识      |   要通过推荐系统，暂时Not doing   | 
|   高德地图定位图标转换为图片      |   暂时Not doing   | 
...
## Testing plan
从个人植物地图形成植物聚集大地图，用植物地图将不同地区的不同植物爱好者连接起来，为各位好奇猫提供好奇心解决平台，保持好奇，探究植物！除此之外呼吁大家关注濒危植物！
...
* 使用后风险报告
  ...
  - 两个API比较之下，阿里智能植物识别API中拥有一个杂草类植物识别，即可识别常见杂草，对于我们的产品来说杂草类植物也同样需求。
  - 由于识别的精准度、和植物数量程度对于本产品有影响，故在综合评估下将选择阿里花伴侣智能植物识别api；若精准度和植物数量对本产品无影响将会选择价格更实惠的百度植物识别api。
  - 百度语音合成API，200字，56秒，语言表达清晰，断句正确，语调正常平稳，女声声音好听！
...
* 人工智能概率性
  ...
  - 百度语音合成API，200字，56秒，语言表达清晰没有读错或读漏，正确率可达98%，此准确率可以满足本产品需求，已可解决用户在行进过程中想要获得植物信息的需求
...
## 迭代发展构想
* 针对植物专家推出植物识别app“植物地图来找茬”
  - 需要植物专家（例如：植物研究人员、植物学教授老师等）以专业身份验证进入系统，或者作为正规植物协会内部使用软件
  - 通过专家专业知识、专业素养来发现百度植物api和阿里智能植物识别api中的漏洞即识别失误之处
  - 需要专家对两家甚至多家植物识别api进行找茬，可以使得公司发现植物识别api的漏洞，包括漏洞布局（如华南植物识别较弱漏洞较多）、漏洞种类（如蕨类植物识别漏洞较多）、气候漏洞（如热带植物漏洞较多）
* 游戏化设计，“植物地图找茬”打卡形成找茬地图
  - 满足植物专家的好胜心、征服欲望，也将学习和发现植物变成小游戏，更加生动有趣
  - 促使提供植物识别api的公司发现自己的漏洞，收集错误数据，及时更新加强自身技术，提高植物识别api的准确度
